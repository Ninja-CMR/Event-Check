...
<template>
  <div class="py-8">
    ...
    <div v-else class="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100 flex flex-col items-center p-8 text-center animate-fade-in">
      ...
      <!-- Informative Message -->
      <div class="bg-blue-50 border border-blue-200 rounded-2xl p-4 space-y-2">
        ...
        <ul class="text-xs text-blue-800 space-y-1 ml-7">
          <li>✓ Téléchargez ou sauvegardez votre QR Code</li>
          <li>✓ Présentez-le à l'entrée de l'événement</li>
          <li>✓ Notre personnel le scannera pour valider votre accès</li>
        </ul>
        <p class="text-xs text-blue-700 italic mt-2">
          Note : La validation est effectuée uniquement par le personnel autorisé.
        </p>
      </div>
